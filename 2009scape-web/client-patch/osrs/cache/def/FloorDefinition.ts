...
import { FloType530, FloType530Data } from "./FloType530";
...
export class FloorDefinition {
    ...
    /**
     * 530 path: Floors don't have a per-id getDefinition() indirection — the
     * renderer reads `FloorDefinition.cache[id]` directly. Call this once
     * after Js5Cache is ready; it walks the FloType range and fills the
     * static cache.
     */
    public static async loadFrom530(js5Cache: Js5Cache, maxId: number = 200): Promise<number> {
        let loaded = 0;
