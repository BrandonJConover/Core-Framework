	...
	public void onUseNpc(Player player, Npc npc, Item item) {
		...
		if (npc.getID() == SIDNEY_SMITH && inArray(item.getCatalogId(), PRAYER_RESTORE_POT,
			...
			switch (ItemId.getById(item.getCatalogId())) {
				case FULL_RESTORE_PRAYER_POTION -> calculateExchangeMenu(player, npc, false, item, new Item(PRAYER_CERT));
				case FULL_SUPER_ATTACK_POTION -> calculateExchangeMenu(player, npc, false, item, new Item(SUPER_ATTACK_CERT));
				case FULL_SUPER_STRENGTH_POTION -> calculateExchangeMenu(player, npc, false, item, new Item(SUPER_STRENGTH_CERT));
				case FULL_SUPER_DEFENSE_POTION -> calculateExchangeMenu(player, npc, false, item, new Item(SUPER_DEFENSE_CERT));
				case DRAGON_BONES -> calculateExchangeMenu(player, npc, false, item, new Item(DRAGON_BONES_CERT));
				case LIMPWURT_ROOT -> calculateExchangeMenu(player, npc, false, item, new Item(LIMPWURT_ROOT_CERT));
				case PRAYER_POTION_CERTIFICATE -> calculateExchangeMenu(player, npc, true, new Item(PRAYER_RESTORE_POT), item);
				case SUPER_ATTACK_POTION_CERTIFICATE -> calculateExchangeMenu(player, npc, true, new Item(SUPER_ATTACK_POT), item);
				case SUPER_STRENGTH_POTION_CERTIFICATE -> calculateExchangeMenu(player, npc, true, new Item(SUPER_STRENGTH_POT), item);
				case SUPER_DEFENSE_POTION_CERTIFICATE -> calculateExchangeMenu(player, npc, true, new Item(SUPER_DEFENSE_POT), item);
				case DRAGON_BONE_CERTIFICATE -> calculateExchangeMenu(player, npc, true, new Item(DRAGON_BONES), item);
				case LIMPWURT_ROOT_CERTIFICATE -> calculateExchangeMenu(player, npc, true, new Item(LIMPWURT_ROOT), item);
