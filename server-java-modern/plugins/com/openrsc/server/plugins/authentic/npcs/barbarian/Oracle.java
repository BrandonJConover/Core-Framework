...
public final class Oracle implements
	...
	private void randomResponse(Player player, Npc n) {
		...
		switch (rand) {
			case 0 -> npcsay(player, n, "You must search from within to find your true destiny");
			case 1 -> npcsay(player, n, "No crisps at the party");
			case 2 -> npcsay(player, n, "It is cunning, almost foxlike");
			case 3 -> npcsay(player, n, "Is it waking up time, I'm not quite sure");
			case 4 -> npcsay(player, n, "When in Asgarnia do as the Asgarnians do");
			case 5 -> npcsay(player, n, "The light at the end of the tunnel is the demon infested lava pit");
			case 6 -> npcsay(player, n, "Watch out for cabbages they are green and leafy");
			case 7 -> npcsay(player, n, "Too many cooks spoil the anchovie pizza");
		}
	}
