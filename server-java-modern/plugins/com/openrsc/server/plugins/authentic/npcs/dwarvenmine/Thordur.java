...
public class Thordur implements TalkNpcTrigger {
	...
	private void thordurDialogue(Player player, Npc n, int cID) {
		switch (cID) {
			case WANTED_SAY_HI -> npcsay(player, n, "Well hello there");
			case WHO_ARE_YOU -> {
			...
			case NICE_TO_MEET_YOU -> npcsay(player, n, "Nice to meet you too");
			...
			case HAVE_TO_GO -> npcsay(player, n, "Ok, have a nice day");
			case CAN_I_BUY_IT -> {
			...
			case BE_RIGHT_BACK -> npcsay(player, n, "Ok");
		}
	}
