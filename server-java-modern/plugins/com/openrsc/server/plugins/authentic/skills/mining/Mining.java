...
public final class Mining implements OpLocTrigger, UseLocTrigger {
	...
	private int calcAxeBonus(int axeId) {
		...
		int bonus = 0;
		switch (ItemId.getById(axeId)) {
			case BRONZE_PICKAXE -> bonus = 0;
			case IRON_PICKAXE -> bonus = 1;
			case STEEL_PICKAXE -> bonus = 2;
			case MITHRIL_PICKAXE -> bonus = 4;
			case ADAMANTITE_PICKAXE -> bonus = 8;
			case RUNE_PICKAXE -> bonus = 16;
		}
		return bonus;
	}
