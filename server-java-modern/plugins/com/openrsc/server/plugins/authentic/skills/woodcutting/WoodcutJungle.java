...
public class WoodcutJungle implements OpLocTrigger,
	...
	public int calcAxeBonus(int axeId) {
		...
		switch (ItemId.getById(axeId)) {
			case BRONZE_AXE -> axeBonus = 0;
			case IRON_AXE -> axeBonus = 1;
			case STEEL_AXE -> axeBonus = 2;
			case BLACK_AXE -> axeBonus = 3;
			case MITHRIL_AXE -> axeBonus = 4;
			case ADAMANTITE_AXE -> axeBonus = 8;
			case RUNE_AXE -> axeBonus = 16;
			default -> {}
		}
		return axeBonus;
	}
