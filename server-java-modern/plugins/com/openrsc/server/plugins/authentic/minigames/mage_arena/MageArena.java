		...
		DelayedEvent kolodionEvent = new DelayedEvent(player.getWorld(), player, config().GAME_TICK, "Mage Arena Kolodion Event") {
			...
			public void run() {
				...
				switch(NpcId.getById(npc.getID())) {
					case KOLODION, KOLODION_OGRE -> transformStage = 0;
					case KOLODION_SPIDER -> transformStage = 1;
					case KOLODION_SOULESS -> transformStage = 2;
					case KOLODION_DEMON -> transformStage = 3;
				}
