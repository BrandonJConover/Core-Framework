...
public class GnomeCooking implements OpInvTrigger, UseLocTrigger {
	...
	protected String[] recipeStrings = {
		...
		// 0 Gnomecrunchie
		"%d!".formatted(ItemId.GNOMECRUNCHIE_DOUGH.id()),

		// 1 Choc crunchies
		"%d%d-%d%d-%d%d-%d-%d-%d%d!".formatted(
		...
		// 2 Worm crunchies
		"%d%d-%d%d-%d%d-%d%d-%d-%d-%d%d!".formatted(
		...
		// 4 Spicy crunchies
		"%d%d-%d%d-%d%d-%d%d-%d%d-%d-%d-%d%d!".formatted(
			ItemId.GNOME_SPICE.id(), ItemId.GIANNE_DOUGH.id(), // Step One: Gnome Spice on Gianne Dough
		...
		// 8 Fruit batta
		"%d%d-%d%d-%d%d-%d%d-%d-%d%d-%d%d-%d%d-%d%d!".formatted(
		...
		// 9 Veg batta
		"%d%d-%d%d-%d%d-%d%d-%d%d-%d-%d%d-%d-%d%d!".formatted(
		...
		// 11 VegBall
		"%d%d-%d%d-%d%d-%d%d-%d%d-%d-%d%d!".formatted(
		...
		// 12 Worm hole
		"%d%d-%d%d-%d%d-%d%d-%d%d-%d%d-%d%d-%d%d-%d-%d%d!".formatted(
		...
		"%d%d-%d%d-%d%d-%d%d-%d%d-%d%d-%d%d-%d%d-%d%d-%d%d-%d%d-%d%d-%d!".formatted(
