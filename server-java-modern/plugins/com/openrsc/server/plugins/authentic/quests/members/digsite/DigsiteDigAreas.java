	...
	public void onUseLoc(Player player, GameObject obj, Item item) {
		if (inArray(obj.getID(), SOIL)) {
			switch (ItemId.getById(item.getCatalogId())) {
				case TROWEL -> trowelOnSite(player, item, obj);
				case SPADE -> doSpade(player, item, obj);
				case ROCK_PICK -> rockPickOnSite(player, item, obj);
				case PANNING_TRAY -> say(player, null, "No I'd better not - it may damage the tray...");
