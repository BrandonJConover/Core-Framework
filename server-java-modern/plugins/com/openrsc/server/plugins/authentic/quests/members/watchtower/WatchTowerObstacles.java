...
public class WatchTowerObstacles implements OpLocTrigger, OpBoundTrigger, UseNpcTrigger {
	...
	public static int[] coordModifier(Player player, boolean up, GameObject object) {
		...
		switch (object.getDirection()) {
			case 0 -> coords[1] -= (up ? -object.getGameObjectDef().getHeight() : 1);
			case 2 -> coords[0] -= (up ? -object.getGameObjectDef().getHeight() : 1);
			case 4 -> coords[1] += (up ? -1 : object.getGameObjectDef().getHeight());
			case 6 -> coords[0] += (up ? -1 : object.getGameObjectDef().getHeight());
		}
		return coords;
	}
