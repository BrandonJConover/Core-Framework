...
public class DragonSlayer implements QuestInterface, UseLocTrigger,
	...
	public void onOpLoc(Player player, GameObject obj, String command) {
		switch (obj.getID()) {
			case DWARVEN_CHEST_OPEN, DWARVEN_CHEST_CLOSED -> {
			...
			case MELZAR_CHEST_OPEN, MELZAR_CHEST_CLOSED -> {
				if (command.equalsIgnoreCase("open")) {
			...
			case LUMBRIDGE_LADY_SARIM1, LUMBRIDGE_LADY_SARIM2 -> {
			...
			case LUMBRIDGE_LADY_CRANDOR1, LUMBRIDGE_LADY_CRANDOR2 -> {
