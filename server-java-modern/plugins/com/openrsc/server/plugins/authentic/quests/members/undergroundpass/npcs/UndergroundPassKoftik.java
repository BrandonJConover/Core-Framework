	...
	public void onTalkNpc(Player player, Npc n) {
		if (n.getID() == NpcId.KOFTIK_ARDOUGNE.id()) {
			switch (player.getQuestStage(this)) {
				case 0 -> player.message("koftik doesn't seem interested in talking");
				case 1 -> koftikEnterCaveDialogue(player, n);
				case 2 -> {
				...
				case 5, 6, 7 -> player.message("koftik doesn't seem interested in talking");
				case 8 -> {
