	...
	public void onTalkNpc(Player player, Npc n) {
		if (n.getID() == NpcId.SKAVID_FINALQUIZ.id()) {
			...
			switch (player.getQuestStage(this)) {
				...
				case 0, 1 -> player.message("The ogre has nothing to say at the moment...");
			...
			switch (player.getQuestStage(this)) {
				case -1 -> player.message("The ogre is not interested in you anymore");
				case 0, 1 -> player.message("He's busy, try him later");
				case 2, 3, 4, 5, 6, 7, 8, 9, 10 -> {
			...
			switch (player.getQuestStage(this)) {
				case -1 -> player.message("The ogre is not interested in you anymore");
				case 0, 1 -> player.message("He is busy at the moment...");
				case 2, 3, 4, 5, 6, 7, 8, 9, 10 -> {
