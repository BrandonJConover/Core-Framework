	...
	public void onTalkNpc(Player player, Npc npc) {
		if (blockTalkNpc(player, npc)) {
			...
			if (option == 0) {
				...
				switch (wisdom) {
					case 0 -> npcsay("The unexamined life is not worth living");
					case 1 -> npcsay("I think therefore I am");
					case 2 -> npcsay("What is rational is actual and what is actual is rational");
					case 3 -> npcsay("One cannot step twice in the same river");
					case 4 -> npcsay("To be is to be perceived");
					case 5 -> npcsay("Liberty consists in doing what one desires");
					case 6 -> npcsay("Even while they teach, men learn");
					case 7 -> npcsay("There is only one good, knowledge, and one evil, ignorance");
					case 8 -> npcsay("Leisure is the mother of philosophy");
					case 9 -> npcsay("We are what we repeatedly do. Excellence, then, is not an act, but a habit");
				}
