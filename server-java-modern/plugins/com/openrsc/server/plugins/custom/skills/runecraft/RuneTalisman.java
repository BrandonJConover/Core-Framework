...
public class RuneTalisman implements OpInvTrigger {
	...
	public void onOpInv(Player player, Integer invIndex, Item item, String command) {
		switch(ItemId.getById(item.getCatalogId())) {
			case AIR_TALISMAN, CURSED_AIR_TALISMAN, ENFEEBLED_AIR_TALISMAN, MIND_TALISMAN, CURSED_MIND_TALISMAN, ENFEEBLED_MIND_TALISMAN, WATER_TALISMAN, CURSED_WATER_TALISMAN, ENFEEBLED_WATER_TALISMAN, EARTH_TALISMAN, CURSED_EARTH_TALISMAN, ENFEEBLED_EARTH_TALISMAN, FIRE_TALISMAN, CURSED_FIRE_TALISMAN, ENFEEBLED_FIRE_TALISMAN, BODY_TALISMAN, CURSED_BODY_TALISMAN, ENFEEBLED_BODY_TALISMAN, COSMIC_TALISMAN, CURSED_COSMIC_TALISMAN, ENFEEBLED_COSMIC_TALISMAN, CHAOS_TALISMAN, CURSED_CHAOS_TALISMAN, ENFEEBLED_CHAOS_TALISMAN, NATURE_TALISMAN, CURSED_NATURE_TALISMAN, ENFEEBLED_NATURE_TALISMAN, LAW_TALISMAN, CURSED_LAW_TALISMAN, ENFEEBLED_LAW_TALISMAN, DEATH_TALISMAN, CURSED_DEATH_TALISMAN, ENFEEBLED_DEATH_TALISMAN, BLOOD_TALISMAN, CURSED_BLOOD_TALISMAN, ENFEEBLED_BLOOD_TALISMAN -> {
