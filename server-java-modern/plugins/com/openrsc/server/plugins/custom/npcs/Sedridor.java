	...
	public void onTalkNpc(Player player, Npc npc) {
		...
		if (config().WANT_RUNECRAFT && player.getQuestStage(Quests.RUNE_MYSTERIES) == 1) {
			...
			switch(player.getQuestStage(Quests.PEELING_THE_ONION)) {
				...
				case PeelingTheOnion.STATE_STARTED_QUEST_WITH_KRESH -> menu.add("Have you been sending people to bother an ogre?");
				case PeelingTheOnion.STATE_STARTED_QUEST_WITH_SEDRIDOR, PeelingTheOnion.STATE_SEDRIDOR_SUGGESTED_YOU_VISIT_MAKE_OVER_MAGE -> menu.add("What was I supposed to do again?");
				case PeelingTheOnion.STATE_STARTED_QUEST_WITH_SEDRIDOR_CONFRONTED_KRESH -> menu.add("I've been to see the ogre");
				case PeelingTheOnion.STATE_PLAYER_CONSIDERS_OGRE -> menu.add("I've reconsidered and I'm ready to become an ogre...");
				default -> isRuneMysteries = true;
			}
		}
