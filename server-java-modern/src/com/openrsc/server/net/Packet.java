...
public class Packet {
	...
	public static void printPacket(Packet packet, String direction) {
		...
		System.out.print("%s Packet Opcode %d:".formatted(direction, opcode));
		for (int i=0; i < length; i++) {
			System.out.print(" %d".formatted(Byte.toUnsignedInt(buffer.readByte())));
		}
		System.out.println();
	...
	public static void printBuffer(ByteBuf buffer, String direction) {
		...
		System.out.print("%s Packet:".formatted(direction));
		for (int i=0; i < length; i++) {
			System.out.print(" %d".formatted(Byte.toUnsignedInt(bufferDup.readByte())));
		}
		System.out.println();
	}
}
