...
public class PayloadProcessorManager {
	...
	private static void bind(OpcodeIn opcode, Class<?> clazz) {
		...
		try {
			...
			if (clazzObject instanceof PayloadProcessor<?, ?> rawProcessor) {
				@SuppressWarnings("unchecked")
				PayloadProcessor<? extends AbstractStruct<OpcodeIn>, OpcodeIn> payloadProcessor = (PayloadProcessor<? extends AbstractStruct<OpcodeIn>, OpcodeIn>) rawProcessor;
