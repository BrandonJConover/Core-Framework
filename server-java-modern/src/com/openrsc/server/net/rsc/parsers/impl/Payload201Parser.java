...
public class Payload201Parser implements PayloadParser<OpcodeIn> {
	...
	private static final Map<Integer, OpcodeIn> opcodes201 = new HashMap<>();
	...
	public static final boolean isPossiblyValid(Map<Integer, OpcodeIn> opcodes, int opcode, int length) {
		...
		return switch (op) {
			case BANK_DEPOSIT, BANK_WITHDRAW -> payloadLength == 4;
			default -> Payload203Parser.isPossiblyValid(opcodes, opcode, length);
		};
	}
