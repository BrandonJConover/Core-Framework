...
public class Payload115Parser implements PayloadParser<OpcodeIn> {
	...
	public OpcodeIn toOpcodeEnum(Packet packet, Player player) {
		return switch (packet.getID()) {
			...
			case 199 -> OpcodeIn.DUEL_FIRST_ACCEPTED;
			case 201 -> OpcodeIn.DUEL_OFFER_ITEM;
			case 200 -> OpcodeIn.DUEL_FIRST_SETTINGS_CHANGED;
			case 203 -> OpcodeIn.DUEL_DECLINED;
			case 198 -> OpcodeIn.DUEL_SECOND_ACCEPTED;
			...
			case 202 -> OpcodeIn.PLAYER_ACCEPTED_TRADE;
			case 212 -> OpcodeIn.PRAYER_ACTIVATED;
			case 211 -> OpcodeIn.PRAYER_DEACTIVATED;
			case 213 -> OpcodeIn.GAME_SETTINGS_CHANGED;
			case 3 -> OpcodeIn.CHAT_MESSAGE;
			case 7 -> OpcodeIn.COMMAND;
			case 31 -> OpcodeIn.PRIVACY_SETTINGS_CHANGED;
			case 207 -> OpcodeIn.BANK_CLOSE;
			case 206 -> OpcodeIn.BANK_WITHDRAW;
			case 205 -> OpcodeIn.BANK_DEPOSIT;
			case 0, 19 -> OpcodeIn.LOGIN; //relogin
			case 2 -> OpcodeIn.REGISTER_ACCOUNT;
			case 4 -> OpcodeIn.FORGOT_PASSWORD;
			case 8 -> OpcodeIn.RECOVERY_ATTEMPT;
			case 25 -> OpcodeIn.CHANGE_PASS;
			case 208 -> OpcodeIn.SET_RECOVERY;
