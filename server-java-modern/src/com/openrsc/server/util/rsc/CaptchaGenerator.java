...
public class CaptchaGenerator {
	...
	public static List<PrerenderedSleepword> prerenderedSleepwords = new ArrayList<>();
	public static List<PrerenderedSleepword> prerenderedSleepwordsSpecial = new ArrayList<>();
