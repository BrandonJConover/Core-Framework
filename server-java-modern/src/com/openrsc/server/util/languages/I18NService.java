...
public class I18NService {
	...
	private void init() {
		enUK = Locale.of("en", "UK");
		enUKMale = Locale.of("en", "UK", "male"); // only messages for the player that depend on their gender
		enUKFemale = Locale.of("en", "UK", "female"); // only messages for the player that depend on their gender
		enUKFemaleNoMisgender = Locale.of("en", "UK", "female_no_misgender"); // only messages for the player that depend on their gender
		enUKGenderNeutral = Locale.of("en", "UK", "gender_neutral"); // only messages for the player that depend on their gender
