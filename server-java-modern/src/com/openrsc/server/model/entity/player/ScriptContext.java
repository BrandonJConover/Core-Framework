...
public class ScriptContext {
	...
	private Entity getInteractingEntity() {
		return switch (getEntityType()) {
			case PLAYER -> getInteractingPlayer();
			case NPC -> getInteractingNpc();
			case LOCATION -> getInteractingLocation();
			case BOUNDARY -> getInteractingBoundary();
			case GROUND_ITEM -> getInteractingGroundItem();
			default -> null; // Not descended from Entity class.
		};
	}
