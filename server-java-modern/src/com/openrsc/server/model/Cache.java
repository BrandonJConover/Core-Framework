...
public class Cache {
	 ...
	 */
	private ConcurrentMap<String, Object> storage = new ConcurrentHashMap<>();
	...
	public String getString(String key) {
		if (!storage.containsKey(key))
			throw new NoSuchElementException("No object found for that key: " + key);
		if (!(storage.get(key) instanceof String stringValue)) {
			throw new IllegalArgumentException(
	...
	public Boolean getBoolean(String key) {
		if (!storage.containsKey(key))
			throw new NoSuchElementException("No object found for that key: " + key);
		if (!(storage.get(key) instanceof Boolean boolValue)) {
			throw new IllegalArgumentException(
