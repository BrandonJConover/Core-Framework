"filename": "/cache/textures/entities_3.png", "start": 7197575, "end": 7373865}, {"filename": "/cache/textures/entities_4.png", "start": 7373865, "end": 7550074}, {"filename": "/cache/textures/model_textures.png", "start": 7550074, "end": 7700857}, {"filename": "/cache/textures/sprites.png", "start": 7700857, "end": 7917513}, {"filename": "/cache/textures17.jag", "start": 7917513, "end": 7981198}], "remote_package_size": 7981198});

  })();

// end include: /tmp/tmpyjtku2gt.js
// include: /tmp/tmpkpkoqvy9.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpkpkoqvy9.js
// include: /tmp/tmpicav7thm.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpicav7thm.js
...
// end include: node_shell_read.js
  ...
  if (!globalThis.WebAssembly) {
    eval(fs.readFileSync(locateFile('mudclient.wasm.js'))+'');
  }
...
function findWasmBinary() {
  return locateFile('mudclient.wasm');
}
...
async function instantiateArrayBuffer(binaryFile, imports) {
  try {
    ...
    var isAppleMobile = globalThis.navigator && (
      /iPad|iPhone|iPod/.test(navigator.userAgent) ||
      (navigator.platform === 'MacIntel' && navigator.maxTouchPoints > 1)
    );
    var isNativeIOS = globalThis.rscNativeConfig && globalThis.rscNativeConfig.platform === 'ios';
    if (isAppleMobile || isNativeIOS) {
      if (globalThis._mudclientNativeMessage) {
        globalThis._mudclientNativeMessage('error', {
          level: 'wasm',
          message: `WebAssembly startup failed: ${reason}`
        });
      }
      abort(reason);
    }
    if (globalThis.location) {
      ...
      // Also check the full href in case a previous redirect placed the param
      // after a # fragment (location.href += '...' appends to the full string).
      if (search.indexOf('_rwasm=0') < 0 && location.href.indexOf('_rwasm=0') < 0) {
        // Rebuild the URL so ?_rwasm=0 is placed before any # fragment.
        var newSearch = search ? search + '&_rwasm=0' : '?_rwasm=0';
...
// Begin runtime exports
  ...
  Module['_emscripten_glFlushMappedBufferRange'] = _emscripten_glFlushMappedBufferRange;
  Module['emscriptenWebGLGetBufferBinding'] = emscriptenWebGLGetBufferBinding;
  Module['emscriptenWebGLValidateMapBufferTarget'] = emscriptenWebGLValidateMapBufferTarget;
  ...
  Module['_emscripten_glGetBufferPointerv'] = _emscripten_glGetBufferPointerv;
  ...
  Module['_emscripten_glMapBufferRange'] = _emscripten_glMapBufferRange;
  ...
  Module['_emscripten_glUnmapBuffer'] = _emscripten_glUnmapBuffer;
...
var ASM_CONSTS = {
 ...
 445890: ($0, $1, $2, $3, $4) => { var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels / 4; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf; },  
 446878: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 446961: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 447030: () => { return window.innerWidth; },  
 447060: () => { return window.innerHeight; },  
 447091: ($0) => { const url = UTF8ToString($0); window.open(url, '_blank'); }
};
...
function get_window_width() { const size = window._mudclientViewportSize ? window._mudclientViewportSize() : null; return size ? size.width : window.innerWidth; }
function get_window_height() { const size = window._mudclientViewportSize ? window._mudclientViewportSize() : null; return size ? size.height : window.innerHeight; }
function browser_trigger_keyboard(text,is_password,x,y,width,height,font,is_centred,is_scaled) { const keyboard = is_password ? window._mudclientPassword : window._mudclientKeyboard; keyboard.value = UTF8ToString(text); if (window._mudclientShouldShowKeyboardInput && !window._mudclientShouldShowKeyboardInput(keyboard)) { if (window._mudclientHideKeyboardInput) { window._mudclientHideKeyboardInput(keyboard); } console.log('[keyboard] Suppressing iOS keyboard input outside user gesture'); return; } if (is_centred) { keyboard.style.height = `${height}px`; keyboard.style.textAlign = 'center'; } else { keyboard.style.height = null; keyboard.style.textAlign = 'left'; } keyboard.style.left = `${x}px`; keyboard.style.top = `${y}px`; keyboard.style.width = `${width}px`; if (is_scaled) { keyboard.style.transform = 'scale(2)'; } else { keyboard.style.transform = 'none'; } const fonts = { 1: 'mudclient-font-bold-12', 4: 'mudclient-font-bold-14', 5: 'mudclient-font-bold-16' }; keyboard.classList.remove(...Object.values(fonts)); const fontClass = fonts[font]; if (fontClass) { keyboard.classList.add(fontClass); } if (window._mudclientPositionKeyboardInput) { window._mudclientPositionKeyboardInput(keyboard, x, y, width, height, is_scaled); } keyboard.style.display = 'block'; if (window._mudclientFocusKeyboardInput) { window._mudclientFocusKeyboardInput(keyboard); } else { keyboard.focus(); } }
...
var _browser_mouse_moved = Module['_browser_mouse_moved'] = makeInvalidEarlyAccess('_browser_mouse_moved');
var _browser_key_pressed = Module['_browser_key_pressed'] = makeInvalidEarlyAccess('_browser_key_pressed');
...
var dynCall_iiiiii = Module['dynCall_iiiiii'] = makeInvalidEarlyAccess('dynCall_iiiiii');
...
var dynCall_ji = Module['dynCall_ji'] = makeInvalidEarlyAccess('dynCall_ji');
var dynCall_jiji = Module['dynCall_jiji'] = makeInvalidEarlyAccess('dynCall_jiji');
var dynCall_i = Module['dynCall_i'] = makeInvalidEarlyAccess('dynCall_i');
var dynCall_iiiiiiii = Module['dynCall_iiiiiiii'] = makeInvalidEarlyAccess('dynCall_iiiiiiii');
var dynCall_iiiiiiiiii = Module['dynCall_iiiiiiiiii'] = makeInvalidEarlyAccess('dynCall_iiiiiiiiii');
var dynCall_iiiiiiiiiiiiiiff = Module['dynCall_iiiiiiiiiiiiiiff'] = makeInvalidEarlyAccess('dynCall_iiiiiiiiiiiiiiff');
var dynCall_iiiiiiiii = Module['dynCall_iiiiiiiii'] = makeInvalidEarlyAccess('dynCall_iiiiiiiii');
var dynCall_viiiiiii = Module['dynCall_viiiiiii'] = makeInvalidEarlyAccess('dynCall_viiiiiii');
var dynCall_viiiiiiiiiii = Module['dynCall_viiiiiiiiiii'] = makeInvalidEarlyAccess('dynCall_viiiiiiiiiii');
var dynCall_iiiiiidiiff = Module['dynCall_iiiiiidiiff'] = makeInvalidEarlyAccess('dynCall_iiiiiidiiff');
var dynCall_vffff = Module['dynCall_vffff'] = makeInvalidEarlyAccess('dynCall_vffff');
var dynCall_vf = Module['dynCall_vf'] = makeInvalidEarlyAccess('dynCall_vf');
var dynCall_viiiiiiii = Module['dynCall_viiiiiiii'] = makeInvalidEarlyAccess('dynCall_viiiiiiii');
var dynCall_viiiiiiiii = Module['dynCall_viiiiiiiii'] = makeInvalidEarlyAccess('dynCall_viiiiiiiii');
var dynCall_vff = Module['dynCall_vff'] = makeInvalidEarlyAccess('dynCall_vff');
var dynCall_vfi = Module['dynCall_vfi'] = makeInvalidEarlyAccess('dynCall_vfi');
var dynCall_viif = Module['dynCall_viif'] = makeInvalidEarlyAccess('dynCall_viif');
var dynCall_vif = Module['dynCall_vif'] = makeInvalidEarlyAccess('dynCall_vif');
var dynCall_viff = Module['dynCall_viff'] = makeInvalidEarlyAccess('dynCall_viff');
var dynCall_vifff = Module['dynCall_vifff'] = makeInvalidEarlyAccess('dynCall_vifff');
var dynCall_viffff = Module['dynCall_viffff'] = makeInvalidEarlyAccess('dynCall_viffff');
var dynCall_viiiiii = Module['dynCall_viiiiii'] = makeInvalidEarlyAccess('dynCall_viiiiii');
var dynCall_vfff = Module['dynCall_vfff'] = makeInvalidEarlyAccess('dynCall_vfff');
var dynCall_viiiiiiiiii = Module['dynCall_viiiiiiiiii'] = makeInvalidEarlyAccess('dynCall_viiiiiiiiii');
var dynCall_viifi = Module['dynCall_viifi'] = makeInvalidEarlyAccess('dynCall_viifi');
var dynCall_iiij = Module['dynCall_iiij'] = makeInvalidEarlyAccess('dynCall_iiij');
var dynCall_viij = Module['dynCall_viij'] = makeInvalidEarlyAccess('dynCall_viij');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['browser_mouse_moved'] != 'undefined', 'missing Wasm export: browser_mouse_moved');
  assert(typeof wasmExports['browser_key_pressed'] != 'undefined', 'missing Wasm export: browser_key_pressed');
  ...
  _browser_mouse_moved = Module['_browser_mouse_moved'] = createExportWrapper('browser_mouse_moved', 2);
  _browser_key_pressed = Module['_browser_key_pressed'] = createExportWrapper('browser_key_pressed', 2);
  ...
  dynCall_iiiiii = dynCalls['iiiiii'] = Module['dynCall_iiiiii'] = createExportWrapper('dynCall_iiiiii', 6);
  ...
  dynCall_ji = dynCalls['ji'] = Module['dynCall_ji'] = createExportWrapper('dynCall_ji', 2);
  dynCall_jiji = dynCalls['jiji'] = Module['dynCall_jiji'] = createExportWrapper('dynCall_jiji', 5);
  dynCall_i = dynCalls['i'] = Module['dynCall_i'] = createExportWrapper('dynCall_i', 1);
  dynCall_iiiiiiii = dynCalls['iiiiiiii'] = Module['dynCall_iiiiiiii'] = createExportWrapper('dynCall_iiiiiiii', 8);
  dynCall_iiiiiiiiii = dynCalls['iiiiiiiiii'] = Module['dynCall_iiiiiiiiii'] = createExportWrapper('dynCall_iiiiiiiiii', 10);
  dynCall_iiiiiiiiiiiiiiff = dynCalls['iiiiiiiiiiiiiiff'] = Module['dynCall_iiiiiiiiiiiiiiff'] = createExportWrapper('dynCall_iiiiiiiiiiiiiiff', 16);
  dynCall_iiiiiiiii = dynCalls['iiiiiiiii'] = Module['dynCall_iiiiiiiii'] = createExportWrapper('dynCall_iiiiiiiii', 9);
  dynCall_viiiiiii = dynCalls['viiiiiii'] = Module['dynCall_viiiiiii'] = createExportWrapper('dynCall_viiiiiii', 8);
  dynCall_viiiiiiiiiii = dynCalls['viiiiiiiiiii'] = Module['dynCall_viiiiiiiiiii'] = createExportWrapper('dynCall_viiiiiiiiiii', 12);
  dynCall_iiiiiidiiff = dynCalls['iiiiiidiiff'] = Module['dynCall_iiiiiidiiff'] = createExportWrapper('dynCall_iiiiiidiiff', 11);
  dynCall_vffff = dynCalls['vffff'] = Module['dynCall_vffff'] = createExportWrapper('dynCall_vffff', 5);
  dynCall_vf = dynCalls['vf'] = Module['dynCall_vf'] = createExportWrapper('dynCall_vf', 2);
  dynCall_viiiiiiii = dynCalls['viiiiiiii'] = Module['dynCall_viiiiiiii'] = createExportWrapper('dynCall_viiiiiiii', 9);
  dynCall_viiiiiiiii = dynCalls['viiiiiiiii'] = Module['dynCall_viiiiiiiii'] = createExportWrapper('dynCall_viiiiiiiii', 10);
  dynCall_vff = dynCalls['vff'] = Module['dynCall_vff'] = createExportWrapper('dynCall_vff', 3);
  dynCall_vfi = dynCalls['vfi'] = Module['dynCall_vfi'] = createExportWrapper('dynCall_vfi', 3);
  dynCall_viif = dynCalls['viif'] = Module['dynCall_viif'] = createExportWrapper('dynCall_viif', 4);
  dynCall_vif = dynCalls['vif'] = Module['dynCall_vif'] = createExportWrapper('dynCall_vif', 3);
  dynCall_viff = dynCalls['viff'] = Module['dynCall_viff'] = createExportWrapper('dynCall_viff', 4);
  dynCall_vifff = dynCalls['vifff'] = Module['dynCall_vifff'] = createExportWrapper('dynCall_vifff', 5);
  dynCall_viffff = dynCalls['viffff'] = Module['dynCall_viffff'] = createExportWrapper('dynCall_viffff', 6);
  dynCall_viiiiii = dynCalls['viiiiii'] = Module['dynCall_viiiiii'] = createExportWrapper('dynCall_viiiiii', 7);
  dynCall_vfff = dynCalls['vfff'] = Module['dynCall_vfff'] = createExportWrapper('dynCall_vfff', 4);
  dynCall_viiiiiiiiii = dynCalls['viiiiiiiiii'] = Module['dynCall_viiiiiiiiii'] = createExportWrapper('dynCall_viiiiiiiiii', 11);
  dynCall_viifi = dynCalls['viifi'] = Module['dynCall_viifi'] = createExportWrapper('dynCall_viifi', 5);
  dynCall_iiij = dynCalls['iiij'] = Module['dynCall_iiij'] = createExportWrapper('dynCall_iiij', 5);
  dynCall_viij = dynCalls['viij'] = Module['dynCall_viij'] = createExportWrapper('dynCall_viij', 5);
