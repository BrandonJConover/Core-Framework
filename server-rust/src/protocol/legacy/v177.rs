//! mudclient177 wire-byte → `OpcodeIn` table.
//!
//! Pure data port of the `toOpcodeEnum` switch block in
//! `server-java-modern/src/com/openrsc/server/net/rsc/parsers/impl/Payload177Parser.java`.
//!
//! mudclient177 adds NPC_COMMAND (byte 195), SLEEPWORD_ENTERED (byte 193),
//! REPORT_ABUSE (byte 51), account-management opcodes (SET_DETAILS, etc.)
//! and a new WALK_TO_POINT byte (194 instead of 255). Released ~2004.

#![allow(dead_code)]

use super::super::opcodes::OpcodeIn;

/// Returns the semantic opcode for a mudclient177 wire byte,
